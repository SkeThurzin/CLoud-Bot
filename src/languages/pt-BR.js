module.exports = {
  ...
  rpgCommand: {
    ...
    `,
    tutorial: `Para começar vamos lembrar seu objetivo que é subir de nivel e ficar forte e obter itens, vá ate as dungeons para completar missões e desbloquear novos mundos e comandos.\n Então vamos começar utilizando seu primeiro comando e tentar encontrar um monstro com \`hunt\`. Boa Sorte!`,
  },
};
